...
@message = private unnamed_addr constant [9 x i8] c"bonjour2\00", align 1
@message.1 = private unnamed_addr constant [8 x i8] c"bonjour\00", align 1
...
define void @autre() {
entree:
  %0 = call i8 (ptr, ...) @printf(ptr @fmt_s, ptr @message)
  ret void
}
...
entree:
  call void @autre()
  %2 = call i8 (ptr, ...) @printf(ptr @fmt_s, ptr @message.1)
  ret i32 0
}
